...
export default function UserProfileModal({ modalRef, closeModal, userName, email }) {
  ...
  return (
    <div
      ref={modalRef}
      className="truncate font-mono text-sm absolute bg-[#0d1117] border border-gray-600 rounded-md shadow-lg p-4 w-48"
      style={{ top: "calc(100% + 8px)", right: "0" }} // Ajuste dinámico
    >
